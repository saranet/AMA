...
class HolidayPageView extends GetView<HolidayPageController> {
  ...
  Widget _buildAddHolidayWidget(BuildContext context) {
    ...
    String? label;
    return AppStorageController.to.currentUser?.roleType ==
      ...
      child: Row(
        children: [
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        16.width,
                        if (controller.allHolidays[index].holidayDate !=
                            null) ...{
                          Text(
                            DateFormat("yyyy-MM-ddTHH:mm:ss")
                                .parse(
                                    controller.allHolidays[index].holidayDate!)
                                .toMMDDYYYY,
                    ...
                    if (controller.allHolidays[index].holidayDate != null) ...{
                      Text(
                        DateFormat("yyyy-MM-ddTHH:mm:ss")
                            .parse(controller.allHolidays[index].holidayDate!)
                            .toWEEKDAY,
          ...
          if (AppStorageController.to.currentUser?.roleType ==
            ...
            IconButton(
              onPressed: () =>
                  controller.deleteHoliday(controller.allHolidays[index]),
